...
public class Frame_DataMaintenance_Segmentrahmen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Segmentrahmen-ID (Key)", "Rahmenart", "Höhe", "Bestand", "Anlagedatum", "Änderungsdatum", "Benutzer"
            }
        ) {
...
//            System.out.println(((Number) jFormattedTextField_value2.getValue()).floatValue());
            ...
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("INSERT INTO DiafBDE.dbo.T_Segmentrahmen (pKey_SR, Rahmenart, Höhe, Bestand, Anlagedatum, Benutzer)" 
    ...
    private void do_updateDataSet_inDB() {        
        try
        {
            ...
            Benutzer = System.getProperty("user.name"); 
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("UPDATE DiafBDE.dbo.T_Segmentrahmen SET Rahmenart = '" + jComboBox_Rahmenart.getItemAt(jComboBox_Rahmenart.getSelectedIndex()) +
