 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Stapelung extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Stapelung
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Stapelung(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stapelung-ID", "Bezeichnung", "Bestand"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenStapelung_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    ...
    public String getChoosenStapelung_ID() {
        return ChoosenStapelung_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Stapelung";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Stapelung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Stapelung dialog = new Dialog_DataUse_Stapelung(new javax.swing.JFrame(), true);
