 ...
 * @author schmidtu
 */
public class Frame_DataMaintenance_Schnitt extends javax.swing.JFrame {
    static int InstanceCount;

    /**
     * Creates new form Frame_DataMaintenance_Schnitt
     */
    public Frame_DataMaintenance_Schnitt() {
        InstanceCount++;
...
//        this.statementResult = 0;
    ...
    private void initComponents() {
        ...
        jCheckBox_Neu_nach_Produktion = new javax.swing.JCheckBox();
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "KWS (Key)", "Bezeichnung", "Beschreibung", "Neu nach Produktion?", "Anlagedatum", "Änderungsdatum", "Benutzer"
            }
        ) {
        ...
        lbl_tableName.setText("Tabelle: Schnitt");
        ...
        jPanel_tableLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_tableLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane_dbData, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel_editTextFields.setPreferredSize(new java.awt.Dimension(714, 23));
        ...
        jPanel_baseLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_baseLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_baseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel_baseLayout.createSequentialGroup()
                        .addGap(8, 8, 8)
                        .addComponent(jPanel_footer, javax.swing.GroupLayout.DEFAULT_SIZE, 716, Short.MAX_VALUE))
                    .addComponent(jPanel_editData, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
...
//            return;
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.T_Schnitt";
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        // TODO add your handling code here:
        if (jTextField_key.getText().isEmpty() || jTextField_key.getText().equals("KWS")) {
            JOptionPane.showMessageDialog(null,
...
//        if (!DataSet_Mode.equals("edit")) {
            ...
            if(OldSelection != -1) {
                ...
                if (tempString.equals("ja")) {
                    jCheckBox_Neu_nach_Produktion.setSelected(true);
                    }else {jCheckBox_Neu_nach_Produktion.setSelected(false);}
                }
...
//        }
    ...
    private void set_textFieldsEmpty() {
        ...
        jCheckBox_Neu_nach_Produktion.setSelected(false);
    ...
    private void set_textFieldsEnabled(boolean aBoolean) {        
        ...
        jCheckBox_Neu_nach_Produktion.setEnabled(true);
    }
...
//            System.out.println(((Number) jFormattedTextField_value2.getValue()).floatValue());
            ...
            myConnection = MY_DBCM.getConnection();
            int myBit;
            if (jCheckBox_Neu_nach_Produktion.isSelected()) {
                myBit = 0;
            }
            else {myBit = 1;}
            SimpleDateFormat myFormat = new SimpleDateFormat("dd.MM.yyyy HH:mm:ss");
            ...
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("INSERT INTO DiafBDE.dbo.T_Schnitt (pKey_KWS, Bezeichnung, Beschreibung, Neu_nach_Produktion, Anlagedatum, Benutzer)" 
    ...
    private void do_updateDataSet_inDB() {        
        try
        {
            ...
            Benutzer = System.getProperty("user.name"); 
//            System.out.println(jTextArea_Beschreibung.getText().trim());
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("UPDATE DiafBDE.dbo.T_Schnitt SET Bezeichnung = '" + jFormattedTextField_Bezeichnung.getText().trim() +
                    "', Beschreibung = '" + jTextArea_Beschreibung.getText().trim() +
                    "', Neu_nach_Produktion = '" + myBit +
                    "', Änderungsdatum = '" + result +
                    "', Benutzer = '" + Benutzer +
                    
                    "' WHERE pKey_KWS = '" + jTextField_key.getText() + "'");             
            } 
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    private int do_deleteDataSet_inDB() {        
        try
        {
            ...
            myConnection = MY_DBCM.getConnection();
            Statement myStatement = myConnection.createStatement();
            statementResult = myStatement.executeUpdate("DELETE FROM DiafBDE.dbo.T_Schnitt WHERE pKey_KWS = '" + jTextField_key.getText().trim() + "'"); 
//            System.out.println(result);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_DataMaintenance_Schnitt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Frame_DataMaintenance_Schnitt().setVisible(true);
        });
    }
    ...
    private javax.swing.JCheckBox jCheckBox_Neu_nach_Produktion;
