 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Stanzblech extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Stanzblech
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Stanzblech(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stanzblech-ID", "Bezeichnung", "Länge", "Breite", "Materialtyp-ID", "Bestand"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenStanzblech_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenStanzblech_ID = "";
        this.dispose();
    ...
    public String getChoosenStanzblech_ID() {
        return ChoosenStanzblech_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Stanzblech";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Stanzblech.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Stanzblech dialog = new Dialog_DataUse_Stanzblech(new javax.swing.JFrame(), true);
