 ...
 * @author schmidtu
 */
public class Frame_DataMaintenance_Ausbrechstempel extends javax.swing.JFrame {
    static int InstanceCount;

    /**
     * Creates new form Frame_DataMaintenance_Ausbrechstempel
     */
    public Frame_DataMaintenance_Ausbrechstempel() {
        InstanceCount++;
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ASB (Key)", "Bezeichnung", "Anlagedatum", "Änderungsdatum", "Benutzer"
            }
        ) {
        ...
        if (jTable_dbData.getColumnModel().getColumnCount() > 0) {
            jTable_dbData.getColumnModel().getColumn(0).setMinWidth(127);
            jTable_dbData.getColumnModel().getColumn(0).setPreferredWidth(127);
            jTable_dbData.getColumnModel().getColumn(1).setMinWidth(200);
            jTable_dbData.getColumnModel().getColumn(1).setPreferredWidth(200);
            jTable_dbData.getColumnModel().getColumn(2).setMinWidth(150);
            ...
            jTable_dbData.getColumnModel().getColumn(4).setMinWidth(100);
        ...
        lbl_tableName.setText("Tabelle: Ausbrechstempel");
        ...
        jPanel_tableLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_tableLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_tableLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPane_dbData, javax.swing.GroupLayout.DEFAULT_SIZE, 734, Short.MAX_VALUE)
        ...
        jPanel_tableLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_tableLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane_dbData, javax.swing.GroupLayout.DEFAULT_SIZE, 367, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel_editDataLayout.setHorizontalGroup(
            ...
            .addComponent(jPanel_editTextFields, javax.swing.GroupLayout.DEFAULT_SIZE, 722, Short.MAX_VALUE)
        ...
        jPanel_baseLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_baseLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_baseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel_footer, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 734, Short.MAX_VALUE)
...
//            return;
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.T_Ausbrechstempel";
            ...
            while (myResultSet.next()) {
                ...
                for (int i = 1; i <= TableColumns; i++) {
                    ...
                    if (myDataSet != null && i == 3 || myDataSet != null && i == 4) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        // TODO add your handling code here:        
        if (jTextField_key.getText().isEmpty() || jTextField_key.getText().equals("ASB")) {
...
//        if (!DataSet_Mode.equals("edit")) {
            ...
            if(OldSelection != -1) {
                ...
                if (myTableModel.getValueAt(myRow, 2) != null) {
                    jTextField_Anlagedatum.setText(myTableModel.getValueAt(myRow, 2).toString().trim());
                }
                else {jTextField_Anlagedatum.setText("");}
                if (myTableModel.getValueAt(myRow, 3) != null) {
                   jTextField_Änderungsdatum.setText(myTableModel.getValueAt(myRow, 3).toString().trim());
                }
                else {jTextField_Änderungsdatum.setText("");}
                if (myTableModel.getValueAt(myRow, 4) != null) {
                    jTextField_Benutzer.setText(myTableModel.getValueAt(myRow, 4).toString().trim()); 
                }
...
//            System.out.println(((Number) jFormattedTextField_value2.getValue()).floatValue());
            ...
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("INSERT INTO DiafBDE.dbo.T_Ausbrechstempel (pKey_ASB, Bezeichnung, Anlagedatum, Benutzer)" 
    ...
    private void do_updateDataSet_inDB() {        
        try
        {
            ...
            Benutzer = System.getProperty("user.name"); 
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("UPDATE DiafBDE.dbo.T_Ausbrechstempel SET Bezeichnung = '" + jFormattedTextField_Bezeichnung.getText().trim() +
                    "', Änderungsdatum = '" + result +
                    "', Benutzer = '" + Benutzer +
                    
                    "' WHERE pKey_ASB = '" + jTextField_key.getText() + "'");             
            } 
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    private void do_deleteDataSet_inDB() {        
        try
        {
            ...
            myConnection = MY_DBCM.getConnection();
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("DELETE FROM DiafBDE.dbo.T_Ausbrechstempel WHERE pKey_ASB = '" + jTextField_key.getText().trim() + "'");             
            }   
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
   ...
   private boolean test_isDataSetInDB(String aString) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_DataMaintenance_Ausbrechstempel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Frame_DataMaintenance_Ausbrechstempel().setVisible(true);
        });
    }
