 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Stanzbrille extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Stanzbrille
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Stanzbrille(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenStanzbrillen_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenStanzbrillen_ID = "";
        this.dispose();
    ...
    public String getChoosenStanzbrillen_ID() {
        return ChoosenStanzbrillen_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Stanzbrille";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Stanzbrille.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Stanzbrille dialog = new Dialog_DataUse_Stanzbrille(new javax.swing.JFrame(), true);
