 ...
 * @author schmidtu
 */
public class Frame_DataMaintenance_Stapelung extends javax.swing.JFrame {
    static int InstanceCount;

    /**
     * Creates new form Frame_DataMaintenance_Stapelung
     */
    public Frame_DataMaintenance_Stapelung() {
        InstanceCount++;
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "KWR (Key)", "Bezeichnung", "Beschreibung", "Bestand", "Anlagedatum", "Änderungsdatum", "Benutzer"
            }
        ) {
        ...
        if (jTable_dbData.getColumnModel().getColumnCount() > 0) {
            ...
            jTable_dbData.getColumnModel().getColumn(3).setMinWidth(100);
        ...
        lbl_tableName.setText("Tabelle: Stapelung");
        ...
        jPanel_tableLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_tableLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane_dbData, javax.swing.GroupLayout.DEFAULT_SIZE, 143, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        lbl_Bestand.setPreferredSize(new java.awt.Dimension(200, 14));
        ...
        jScrollPane2.setViewportView(jTextArea_Beschreibung);

        jPanel_editTextFields.add(jScrollPane2);
        ...
        jPanel_editDataLayout.setHorizontalGroup(
            ...
            .addComponent(jPanel_editLabels, javax.swing.GroupLayout.DEFAULT_SIZE, 805, Short.MAX_VALUE)
        ...
        jPanel_baseLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_baseLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_baseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel_footer, javax.swing.GroupLayout.DEFAULT_SIZE, 817, Short.MAX_VALUE)
...
//            return;
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.T_Stapelung";
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        // TODO add your handling code here:
        if (jTextField_key.getText().isEmpty() || jTextField_key.getText().equals("KWR")) {
            JOptionPane.showMessageDialog(null,
...
//        if (!DataSet_Mode.equals("edit")) {
            ...
            if(OldSelection != -1) {
                ...
                jFormattedTextField_Bestand.setText(tempString);
                }
                else {jFormattedTextField_Bezeichnung.setText("");}
...
//            System.out.println(((Number) jFormattedTextField_value2.getValue()).floatValue());
            ...
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("INSERT INTO DiafBDE.dbo.T_Stapelung (pKey_KWR, Bezeichnung, Beschreibung, Bestand, Anlagedatum, Benutzer)" 
    ...
    private void do_updateDataSet_inDB() {        
        try
        {
            ...
            Benutzer = System.getProperty("user.name"); 
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("UPDATE DiafBDE.dbo.T_Stapelung SET Bezeichnung = '" + jFormattedTextField_Bezeichnung.getText().trim() +
                    "', Beschreibung = '" + jTextArea_Beschreibung.getText().trim() +
                    "', Bestand = '" + jFormattedTextField_Bestand.getText().trim() +
                    "', Änderungsdatum = '" + result +
                    "', Benutzer = '" + Benutzer +
                    
                    "' WHERE pKey_KWR = '" + jTextField_key.getText() + "'");             
            } 
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    private void do_deleteDataSet_inDB() {        
        try
        {
            ...
            myConnection = MY_DBCM.getConnection();
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("DELETE FROM DiafBDE.dbo.T_Stapelung WHERE pKey_KWR = '" + jTextField_key.getText().trim() + "'");             
            }   
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_DataMaintenance_Stapelung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Frame_DataMaintenance_Stapelung().setVisible(true);
        });
    }
