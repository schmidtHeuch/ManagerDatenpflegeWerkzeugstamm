 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Ausbrechstempel extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Ausbrechstempel
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Ausbrechstempel(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    String ChoosenAusbrechstempel_ID;
    /**
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ausbrechstempel-ID", "Bezeichnung"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenAusbrechstempel_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenAusbrechstempel_ID = "";
        this.dispose();
    ...
    public String getChoosenAusbrechstempel_ID() {
        return ChoosenAusbrechstempel_ID;
    }
    ...
    private void get_DBTableData() {           
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Ausbrechstempel";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Ausbrechstempel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Ausbrechstempel dialog = new Dialog_DataUse_Ausbrechstempel(new javax.swing.JFrame(), true);
