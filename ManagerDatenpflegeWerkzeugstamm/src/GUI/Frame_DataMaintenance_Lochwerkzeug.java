 ...
 * @author schmidtu
 */
public class Frame_DataMaintenance_Lochwerkzeug extends javax.swing.JFrame {

    /**
     * Creates new form Frame_DataMaintenance_Lochwerkzeug
     */
    ...
    private void initComponents() {
        ...
        lbl_tableName.setText("Tabelle: Lochwerkzeug");
...
//            String myTempSQL = "CREATE TABLE #tempSegment FROM DiafBDE.dbo.T_Segment";
            String mySQL = "SELECT * FROM DiafBDE.dbo.T_Lochwerkzeug"; // ORDER BY T_Segment.pKey_KP"; // WHERE tma_abt='Technik'";
...
//                myTableModel.addRow(myValue); 
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        // TODO add your handling code here:
        if (jTextField_key.getText().isEmpty() || jTextField_key.getText().equals("LW")) {
            JOptionPane.showMessageDialog(null,
...
//            System.out.println(((Number) jFormattedTextField_value2.getValue()).floatValue());
    ...
    private void do_updateDataSet_inDB() {        
        try
        {
            ...
            myStatement.executeUpdate("UPDATE DiafBDE.dbo.T_Lochwerkzeug SET Bezeichnung = '" + jFormattedTextField_Bezeichnung.getText().trim() +
                    ...
                    "' WHERE pKey_LW = '" + jTextField_key.getText() + "'");             
            } 
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    private void do_deleteDataSet_inDB() {        
        try
        {
            ...
            myConnection = MY_DBCM.getConnection();
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("DELETE FROM DiafBDE.dbo.T_Lochwerkzeug WHERE pKey_LW = '" + jTextField_key.getText().trim() + "'");             
            }   
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_DataMaintenance_Lochwerkzeug.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Frame_DataMaintenance_Lochwerkzeug().setVisible(true);
        });
    }
