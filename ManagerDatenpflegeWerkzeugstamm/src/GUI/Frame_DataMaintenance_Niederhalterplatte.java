 ...
 * @author schmidtu
 */
public class Frame_DataMaintenance_Niederhalterplatte extends javax.swing.JFrame {
    static int InstanceCount;

    /**
     * Creates new form Frame_DataMaintenance_Niederhalterplatte
     */
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "KWNP (Key)", "Bezeichnung", "Anlagedatum", "Änderungsdatum", "Benutzer"
            }
        ) {
        ...
        lbl_tableName.setText("Tabelle: Niederhalterplatte");
        ...
        jPanel_tableLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_tableLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane_dbData, javax.swing.GroupLayout.DEFAULT_SIZE, 317, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel_baseLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_baseLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_baseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel_footer, javax.swing.GroupLayout.DEFAULT_SIZE, 720, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(jPanel_baseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
//            return;
    ...
    private void get_DBTableData() {         
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.T_Niederhalterplatte";
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        // TODO add your handling code here:
        if (jTextField_key.getText().isEmpty() || jTextField_key.getText().equals("KWNP")) {
            JOptionPane.showMessageDialog(null,
...
//            System.out.println(((Number) jFormattedTextField_value2.getValue()).floatValue());
            ...
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("INSERT INTO DiafBDE.dbo.T_Niederhalterplatte (pKey_KWNP, Bezeichnung, Anlagedatum, Benutzer)" 
    ...
    private void do_updateDataSet_inDB() {        
        try
        {
            ...
            Benutzer = System.getProperty("user.name"); 
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("UPDATE DiafBDE.dbo.T_Niederhalterplatte SET Bezeichnung = '" + jFormattedTextField_Bezeichnung.getText().trim() +
                    "', Änderungsdatum = '" + result +
                    "', Benutzer = '" + Benutzer +
                    
                    "' WHERE pKey_KWNP = '" + jTextField_key.getText() + "'");             
            } 
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    private void do_deleteDataSet_inDB() {        
        try
        {
            ...
            myConnection = MY_DBCM.getConnection();
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("DELETE FROM DiafBDE.dbo.T_Niederhalterplatte WHERE pKey_KWNP = '" + jTextField_key.getText().trim() + "'");             
            }   
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_DataMaintenance_Niederhalterplatte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Frame_DataMaintenance_Niederhalterplatte().setVisible(true);
        });
    }
