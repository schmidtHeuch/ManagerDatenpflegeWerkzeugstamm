 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Grundplatte extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Grundplatte
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Grundplatte(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Grundplatten-ID", "Grundplattenstärke", "Bestand"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenGrundplatten_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenGrundplatten_ID = "";
        this.dispose();
    ...
    public String getChoosenGrundplatten_ID() {
        return ChoosenGrundplatten_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Grundplatte";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Grundplatte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Grundplatte dialog = new Dialog_DataUse_Grundplatte(new javax.swing.JFrame(), true);
