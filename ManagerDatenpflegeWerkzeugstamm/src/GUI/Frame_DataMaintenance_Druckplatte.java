 ...
 * @author schmidtu
 */
public class Frame_DataMaintenance_Druckplatte extends javax.swing.JFrame {
    static int InstanceCount;

    /**
     * Creates new form Frame_DataMaintenance_Druckplatte
     */
    ...
    private void do_postBuild() {                
        ...
        jFormattedTextField_Druckplattenstärke.addKeyListener(tfKeyListener);
        jFormattedTextField_Druckplatten_Nut_Länge.addKeyListener(tfKeyListener);
        jFormattedTextField_Druckplatten_Nut_Breite.addKeyListener(tfKeyListener);
        jFormattedTextField_Achsmaß_Länge.addKeyListener(tfKeyListener);
        jFormattedTextField_Achsmaß_Breite.addKeyListener(tfKeyListener);
    ...
    private void initComponents() {
        ...
        lbl_Achsmaß_Länge = new javax.swing.JLabel();
        lbl_Achsmaß_Breite = new javax.swing.JLabel();
        ...
        jFormattedTextField_Achsmaß_Länge = new javax.swing.JFormattedTextField();
        jFormattedTextField_Achsmaß_Breite = new javax.swing.JFormattedTextField();
        ...
        lbl_tableName.setText("Tabelle: Druckplatte");
        ...
        jPanel_tableLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_tableLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane_dbData, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        lbl_Achsmaß_Länge.setPreferredSize(new java.awt.Dimension(100, 14));
        jPanel_editLabels.add(lbl_Achsmaß_Länge);

        lbl_Achsmaß_Breite.setText("Achsmaß Breite");
        lbl_Achsmaß_Breite.setPreferredSize(new java.awt.Dimension(100, 14));
        jPanel_editLabels.add(lbl_Achsmaß_Breite);
        ...
        jFormattedTextField_Achsmaß_Länge.setEnabled(false);
        ...
        jFormattedTextField_Achsmaß_Breite.setEnabled(false);
        ...
        jPanel_editDataLayout.setHorizontalGroup(
            ...
            .addComponent(jPanel_editLabels, javax.swing.GroupLayout.DEFAULT_SIZE, 883, Short.MAX_VALUE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_editDataLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_editDataLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_editDataLayout.createSequentialGroup()
                        ...
                        .addGap(27, 27, 27))
                    .addComponent(jPanel_editButtons, javax.swing.GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel_baseLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_baseLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_baseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel_footer, javax.swing.GroupLayout.DEFAULT_SIZE, 895, Short.MAX_VALUE))
                .addContainerGap())
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.T_Druckplatte";
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        ...
        jFormattedTextField_Druckplattenstärke.requestFocus();
        btn_new.setEnabled(false);
        btn_edit.setEnabled(false);
        btn_duplicate.setEnabled(false);
        btn_delete.setEnabled(false);
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        if (DataSet_Mode.equals("delete") && test_isDataSetInDB(jTextField_key.getText().trim()) == true) {
            int myAnswer = JOptionPane.showConfirmDialog(null,
                "Soll der Datensatz Druckplatten-ID (Key): \n\n >> " + jTextField_key.getText().trim() + " << \n\n wirklich gelöscht werden?",
                "Datensatz löschen?",
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        // TODO add your handling code here:
        if (jTextField_key.getText().isEmpty() || jTextField_key.getText().equals("DPL")) {
            ...
            if (myAnswer == true) {
                ...
                if (DataSet_Mode.equals("edit") && !Old_Bezeichnung.equals(jFormattedTextField_Bezeichnung.getText().trim())
                    ...
                    || !Old_Achsmaß_Breite.equals(jFormattedTextField_Achsmaß_Breite.getText().trim())
...
//        }
    ...
    private void set_textFieldsEmpty() {
        ...
        jFormattedTextField_Achsmaß_Länge.setText("");
        jFormattedTextField_Achsmaß_Breite.setText("");
    ...
    private void set_textFieldsEnabled(boolean aBoolean) {        
        ...
        jFormattedTextField_Achsmaß_Länge.setEnabled(true);
        jFormattedTextField_Achsmaß_Breite.setEnabled(true);
...
//            System.out.println(((Number) jFormattedTextField_value2.getValue()).floatValue());
            ...
            myStatement.executeUpdate("INSERT INTO DiafBDE.dbo.T_Druckplatte (pKey_DPL, Bezeichnung, Beschreibung, Druckplattenstärke, "
                    ...
                    + jFormattedTextField_Achsmaß_Länge.getText().trim() + "', '"
                    + jFormattedTextField_Achsmaß_Breite.getText().trim() + "', '"
    ...
    private void do_updateDataSet_inDB() {        
        try
        {
            ...
            myStatement.executeUpdate("UPDATE DiafBDE.dbo.T_Druckplatte SET Bezeichnung = '" + jFormattedTextField_Bezeichnung.getText().trim() +
                    ...
                    "', Achsmaß_Breite = '" + jFormattedTextField_Achsmaß_Breite.getText().trim() +
                    "', Bestand = '" + jFormattedTextField_Bestand.getText().trim() +
                    "', Änderungsdatum = '" + result +
                    "', Benutzer = '" + Benutzer +
                    
                    "' WHERE pKey_DPL = '" + jTextField_key.getText() + "'");             
            } 
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    private void do_deleteDataSet_inDB() {        
        try
        {
            ...
            myConnection = MY_DBCM.getConnection();
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("DELETE FROM DiafBDE.dbo.T_Druckplatte WHERE pKey_DPL = '" + jTextField_key.getText().trim() + "'");             
            }   
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_DataMaintenance_Druckplatte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Frame_DataMaintenance_Druckplatte().setVisible(true);
        });
    }
    ...
    private javax.swing.JLabel lbl_Achsmaß_Breite;
