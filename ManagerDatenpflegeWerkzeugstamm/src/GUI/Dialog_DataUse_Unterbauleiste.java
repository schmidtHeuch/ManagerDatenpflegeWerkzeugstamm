 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Unterbauleiste extends javax.swing.JDialog {

    /** Creates new form Dialog_DataUse_Unterbauleiste
     * @param parent
     * @param modal */
    public Dialog_DataUse_Unterbauleiste(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    String ChoosenUnterbauleisten_ID;
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Unterbauleisten-ID", "Höhe", "Bestand"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenUnterbauleisten_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenUnterbauleisten_ID = "";
        this.dispose();
    ...
    public String getChoosenUnterbauleisten_ID() {
        return ChoosenUnterbauleisten_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Unterbauleiste";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Unterbauleiste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Unterbauleiste dialog = new Dialog_DataUse_Unterbauleiste(new javax.swing.JFrame(), true);
