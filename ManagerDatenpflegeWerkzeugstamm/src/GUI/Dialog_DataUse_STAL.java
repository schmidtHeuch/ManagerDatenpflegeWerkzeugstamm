 ...
 * @author schmidtu
 */
public class Dialog_DataUse_STAL extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_STAL
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_STAL(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STAL-ID", "Bezeichnung", "Säulengestell-Nr."
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenSTAL_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    ...
    public String getChoosenSTAL_ID() {
        return ChoosenSTAL_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_STAL";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_STAL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_STAL dialog = new Dialog_DataUse_STAL(new javax.swing.JFrame(), true);
