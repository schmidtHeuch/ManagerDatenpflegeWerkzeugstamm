 ...
 * @author schmidtu
 */
public class Frame_DataMaintenance_STAL extends javax.swing.JFrame {
    static int InstanceCount;

    /**
     * Creates new form Frame_DataMaintenance_STAL
     */
    public Frame_DataMaintenance_STAL() {
        InstanceCount++;
    ...
    private void do_postBuild() {                
        ...
        jFormattedTextField_Säulengestell_Nr.addKeyListener(tfKeyListener);
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STAL (Key)", "Bezeichnung", "Beschreibung", "Säulengestell-Nr.", "Anlagedatum", "Änderungsdatum", "Benutzer"
            }
        ) {
        ...
        lbl_tableName.setText("Tabelle: STAL");
        ...
        jPanel_tableLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_tableLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_tableLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane_dbData, javax.swing.GroupLayout.DEFAULT_SIZE, 713, Short.MAX_VALUE)
                    .addGroup(jPanel_tableLayout.createSequentialGroup()
                        .addGroup(jPanel_tableLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel_tableLayout.createSequentialGroup()
        ...
        jPanel_tableLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_tableLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane_dbData, javax.swing.GroupLayout.DEFAULT_SIZE, 251, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jFormattedTextField_Säulengestell_Nr.setPreferredSize(new java.awt.Dimension(150, 20));
        ...
        jPanel_editTextFields.add(jFormattedTextField_Saeulengestell_Bezeichnung);
        ...
        jPanel_editDataLayout.setHorizontalGroup(
            ...
            .addComponent(jPanel_editTextFields, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
        ...
        jPanel_baseLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_baseLayout.createSequentialGroup()
                ...
                .addComponent(jPanel_editData, javax.swing.GroupLayout.PREFERRED_SIZE, 206, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(60, 60, 60))
            .addGroup(jPanel_baseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel_baseLayout.createSequentialGroup()
                    .addContainerGap()
...
//            String myTempSQL = "CREATE TABLE #tempSegment FROM DiafBDE.dbo.T_Segment";
            String mySQL = "SELECT * FROM DiafBDE.dbo.T_STAL"; // ORDER BY T_Segment.pKey_KP"; // WHERE tma_abt='Technik'";
...
//                myTableModel.addRow(myValue); 
    ...
    private void btn_openDialog_SäulengestellActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_openDialog_SäulengestellActionPerformed
        // TODO add your handling code here:
        Dialog_DataUse_Säulengestell myDialog = new Dialog_DataUse_Säulengestell(this,true);
        ...
        if (!resultFromDialog_ID.equals("")) {
            String resultFromDialog_Descriptiong = myDialog.getSäulengestell_Bezeichnung().trim();
            this.jFormattedTextField_Säulengestell_Nr.setValue(resultFromDialog_ID);
            this.jFormattedTextField_Saeulengestell_Bezeichnung.setText(resultFromDialog_Descriptiong);
        }
    ...
    private void btn_newActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_newActionPerformed
        ...
        btn_openDialog_Säulengestell.setEnabled(true);
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        // TODO add your handling code here:
        if (jTextField_key.getText().isEmpty() || jTextField_key.getText().equals("STAL")) {
            JOptionPane.showMessageDialog(null,
...
//            System.out.println(((Number) jFormattedTextField_value2.getValue()).floatValue());
            ...
            if (jFormattedTextField_Säulengestell_Nr.getText().trim().equals("")) {
                jFormattedTextField_Säulengestell_Nr.setText("SG0");
            }
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("INSERT INTO DiafBDE.dbo.T_STAL (pKey_STAL, Bezeichnung, Beschreibung, Säulengestell_Nr, Anlagedatum, Benutzer)" 
    ...
    private void do_updateDataSet_inDB() {        
        try
        {
            ...
            Benutzer = System.getProperty("user.name"); 
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("UPDATE DiafBDE.dbo.T_STAL SET Bezeichnung = '" + jFormattedTextField_Bezeichnung.getText().trim() +
                    ...
                    "' WHERE pKey_STAL = '" + jTextField_key.getText() + "'");             
            } 
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    private void do_deleteDataSet_inDB() {        
        try
        {
            ...
            myConnection = MY_DBCM.getConnection();
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("DELETE FROM DiafBDE.dbo.T_STAL WHERE pKey_STAL = '" + jTextField_key.getText().trim() + "'");             
            }   
        }
        catch (/*ClassNotFoundException |*/ SQLException myException )
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_DataMaintenance_STAL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Frame_DataMaintenance_STAL().setVisible(true);
        });
    }
    ...
    private javax.swing.JTextField jFormattedTextField_Saeulengestell_Bezeichnung;
    private javax.swing.JFormattedTextField jFormattedTextField_Säulengestell_Nr;
    private javax.swing.JLabel jLabel_Saeulengestell_Bezeichnung;
