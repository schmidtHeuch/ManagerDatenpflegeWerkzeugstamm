 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Schriftzug extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Schriftzug
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Schriftzug(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Schriftzug-ID", "Bezeichnung", "Gravur-Nr."
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenSchriftzug_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenSchriftzug_ID = "";
        this.dispose();
    ...
    public String getChoosenSchriftzug_ID() {
        return ChoosenSchriftzug_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Schriftzug";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Schriftzug.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Schriftzug dialog = new Dialog_DataUse_Schriftzug(new javax.swing.JFrame(), true);
