 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Segment extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Dialog_DataUse_
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Segment(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Segment-ID", "Plattenstärke", "Segmenttyp", "Zugehörigkeit"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenSegment_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    ...
    public String getChoosenSegment_ID() {
        return ChoosenSegment_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Segment";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Segment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Segment dialog = new Dialog_DataUse_Segment(new javax.swing.JFrame(), true);
