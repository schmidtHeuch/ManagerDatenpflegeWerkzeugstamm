 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Führungskäfig extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Führungskäfig
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Führungskäfig(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    String ChoosenFührungskäfig_ID;
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenFührungskäfig_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenFührungskäfig_ID = "";
        this.dispose();
    ...
    public String getChoosenFührungskäfig_ID() {
        return ChoosenFührungskäfig_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Führungskäfig";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Führungskäfig.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Führungskäfig dialog = new Dialog_DataUse_Führungskäfig(new javax.swing.JFrame(), true);
