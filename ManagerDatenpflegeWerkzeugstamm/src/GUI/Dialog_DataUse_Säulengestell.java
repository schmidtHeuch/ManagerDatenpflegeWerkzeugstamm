...
public class Dialog_DataUse_Säulengestell extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Säulengestell-Nr.", "Bezeichnung", "Beschreibung"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenSäulengestell_Nr = myTableModel.getValueAt(myRow, 0).toString();
        ChoosenSäulengestell_Bezeichnung = myTableModel.getValueAt(myRow, 1).toString();
        this.dispose();
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Säulengestell";
