 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Säulengestell extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Säulengestell
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Säulengestell(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    String ChoosenSäulengestell_Nr;
    String ChoosenSäulengestell_Bezeichnung;
    /**
...
//        String tempString = myTableModel.getValueAt(jTable_dbData.getSelectedRow(), 0).toString();
        ChoosenSäulengestell_Nr = myTableModel.getValueAt(jTable_dbData.getSelectedRow(), 0).toString(); //Integer.parseInt(tempString);
        ChoosenSäulengestell_Bezeichnung = myTableModel.getValueAt(jTable_dbData.getSelectedRow(), 1).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenSäulengestell_Nr = "";
        this.dispose();
    ...
    public String getChoosenSäulengestell_Nr() {
        return ChoosenSäulengestell_Nr;
    }                                          

    public String getSäulengestell_Bezeichnung() {
        return ChoosenSäulengestell_Bezeichnung;
    }
...
//            String myTempSQL = "CREATE TABLE #tempSegment FROM DiafBDE.dbo.T_Segment";
            String mySQL = "SELECT * FROM DiafBDE.dbo.T_Säulengestell"; // ORDER BY T_Segment.pKey_KP"; // WHERE tma_abt='Technik'";
...
//                return;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Säulengestell.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Säulengestell dialog = new Dialog_DataUse_Säulengestell(new javax.swing.JFrame(), true);
