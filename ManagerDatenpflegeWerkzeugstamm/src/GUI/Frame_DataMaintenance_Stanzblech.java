...
public class Frame_DataMaintenance_Stanzblech extends javax.swing.JFrame {
    ...
    private void do_postBuild() {                
        ...
        jFormattedTextField_Länge.addKeyListener(tfKeyListener);
        jFormattedTextField_Breite.addKeyListener(tfKeyListener);
        jFormattedTextField_Materialtyp_ID.addKeyListener(tfKeyListener);
        jFormattedTextField_Bestand.addKeyListener(tfKeyListener);
...
//        }
    ...
    private void initComponents() {
        ...
        jScrollPane_Beschreibung = new javax.swing.JScrollPane();
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stanzblech-ID (Key)", "Bezeichnung", "Beschreibung", "Länge", "Breite", "Materialtyp-ID", "Bestand", "Anlagedatum", "Änderungsdatum", "Benutzer"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Long.class, java.lang.Long.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class
            };
        ...
        if (jTable_dbData.getColumnModel().getColumnCount() > 0) {
            ...
            jTable_dbData.getColumnModel().getColumn(5).setPreferredWidth(250);
        ...
        jPanel_tableLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_tableLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane_dbData, javax.swing.GroupLayout.DEFAULT_SIZE, 701, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        lbl_Materialtyp_ID.setPreferredSize(new java.awt.Dimension(104, 14));
        jPanel_editLabels.add(lbl_Materialtyp_ID);

        btn_openDialog_Materialtyp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Lupe.png"))); // NOI18N
        ...
        btn_delete_Materialtyp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Löschen.png"))); // NOI18N
        ...
        lbl_Materialtyp_Bezeichnung.setPreferredSize(new java.awt.Dimension(100, 14));
        ...
        jScrollPane_Beschreibung.setViewportView(jTextArea_Beschreibung);

        jPanel_editTextFields.add(jScrollPane_Beschreibung);

        jFormattedTextField_Länge.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)), javax.swing.BorderFactory.createEmptyBorder(1, 2, 1, 2)));
        ...
        jFormattedTextField_Breite.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)), javax.swing.BorderFactory.createEmptyBorder(1, 2, 1, 2)));
        ...
        jFormattedTextField_Materialtyp_ID.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)), javax.swing.BorderFactory.createEmptyBorder(1, 2, 1, 2)));
        ...
        jFormattedTextField_Materialtyp_ID.setPreferredSize(new java.awt.Dimension(150, 20));
        ...
        jFormattedTextField_MaterialtypBezeichnung.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)), javax.swing.BorderFactory.createEmptyBorder(1, 2, 1, 2)));
        ...
        jFormattedTextField_MaterialtypBezeichnung.setPreferredSize(new java.awt.Dimension(100, 20));
...
//                set_textFieldsDisabled();
    ...
    private void btn_openDialog_MaterialtypActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_openDialog_MaterialtypActionPerformed
        ...
        myDialog.setLocation(location.x + 10 , location.y - 300);
        myDialog.setVisible(true);
        int resultFromDialog_ID = myDialog.getChoosenMaterialtypID();
        if (resultFromDialog_ID != -1) {
    ...
    private void btn_delete_MaterialtypActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_delete_MaterialtypActionPerformed
        ...
        jFormattedTextField_MaterialtypBezeichnung.setText("keine Auswahl");
    ...
    private void do_insertDataSet_intoDB() {        
        try
        {
            ...
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("INSERT INTO DiafBDE.dbo.T_Stanzblech (pKey_B, Bezeichnung, Beschreibung, Länge, Breite, Materialtyp_ID, "
                    + "Bestand, Anlagedatum, Benutzer)" 
    ...
    private javax.swing.JScrollPane jScrollPane_Beschreibung;
