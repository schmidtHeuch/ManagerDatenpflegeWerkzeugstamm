...
public class Dialog_DataUse_Materialtyp extends javax.swing.JDialog {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        String tempString = myTableModel.getValueAt(myRow, 0).toString();
        ChoosenMaterialtypID = Integer.parseInt(tempString);
        ChoosenMaterialtypDescription = myTableModel.getValueAt(myRow, 1).toString();
        this.dispose();
    ...
    private void get_DBTableData() {           
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Materialtyp";
