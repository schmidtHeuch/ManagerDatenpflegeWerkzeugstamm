 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Grundformstamm extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Grundformstamm
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Grundformstamm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Grundform-ID", "Bezeichnung", "Druckrahmen", "Segmentrahmen", "Unterbauleiste", "Kühlplatte", "Grundplatte", "Druckplatte"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenGrundform_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    ...
    public String getChoosenGrundform_ID() {
            return ChoosenGrundform_ID;
        }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Grundformstamm";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Grundformstamm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Grundformstamm dialog = new Dialog_DataUse_Grundformstamm(new javax.swing.JFrame(), true);
