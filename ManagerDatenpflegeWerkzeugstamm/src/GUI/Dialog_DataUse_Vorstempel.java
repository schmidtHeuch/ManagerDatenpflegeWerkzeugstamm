 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Vorstempel extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Vorstempel
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Vorstempel(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenVorstempel_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenVorstempel_ID = "";
        this.dispose();
    ...
    public String getChoosenVorstempel_ID() {
        return ChoosenVorstempel_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Vorstempel";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Vorstempel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Vorstempel dialog = new Dialog_DataUse_Vorstempel(new javax.swing.JFrame(), true);
