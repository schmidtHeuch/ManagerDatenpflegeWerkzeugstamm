 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Zentrierer extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Zentrierer
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Zentrierer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenZentrierer_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenZentrierer_ID = "";
        this.dispose();
    ...
    public String getChoosenZentrierer_ID() {
        return ChoosenZentrierer_ID;
    }
    ...
    private void get_DBTableData() {           
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Zentrierer";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Zentrierer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Zentrierer dialog = new Dialog_DataUse_Zentrierer(new javax.swing.JFrame(), true);
