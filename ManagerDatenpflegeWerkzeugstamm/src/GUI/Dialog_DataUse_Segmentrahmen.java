 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Segmentrahmen extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Segmentrahmen
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Segmentrahmen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    String ChoosenSegmentrahmen_ID;
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Segmentrahmen-ID", "Rahmenart", "Höhe", "Bestand"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenSegmentrahmen_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenSegmentrahmen_ID = "";
        this.dispose();
    ...
    public String getChoosenSegmentrahmen_ID() {
        return ChoosenSegmentrahmen_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Segmentrahmen";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Segmentrahmen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Segmentrahmen dialog = new Dialog_DataUse_Segmentrahmen(new javax.swing.JFrame(), true);
