 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Kühlplatte extends javax.swing.JDialog {

    /** Creates new form Dialog_DataUse_Kühlplatte
     * @param parent
     * @param modal */
    public Dialog_DataUse_Kühlplatte(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kühlplatten-ID", "Kühlplattenstärke", "Länge", "Breite", "Bestand"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenKühlplatten_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    }//GEN-LAST:event_btn_acceptActionPerformed

    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        // TODO add your handling code here:
        ChoosenKühlplatten_ID = "";
        this.dispose();
    ...
    public String getChoosenKühlplatten_ID() {
        return ChoosenKühlplatten_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Kühlplatte";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Kühlplatte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Kühlplatte dialog = new Dialog_DataUse_Kühlplatte(new javax.swing.JFrame(), true);
