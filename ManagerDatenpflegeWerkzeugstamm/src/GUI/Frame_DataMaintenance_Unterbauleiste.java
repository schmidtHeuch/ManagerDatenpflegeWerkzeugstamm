...
public class Frame_DataMaintenance_Unterbauleiste extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Unterbauleisten-ID (Key)", "Höhe", "Bestand", "Anlagedatum", "Änderungsdatum", "Benutzer"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        if (jTextField_key.getText().isEmpty() || jTextField_key.getText().equals("UBL")) {
            ...
            if (myAnswer == true) {
                ...
                if (DataSet_Mode.equals("edit") && !Old_Höhe.equals(jFormattedTextField_Höhe.getText().trim())
...
//            System.out.println(((Number) jFormattedTextField_value2.getValue()).floatValue());
            ...
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("INSERT INTO DiafBDE.dbo.T_Unterbauleiste (pKey_UBL, Höhe, Bestand, Anlagedatum, Benutzer)" 
    ...
    private void do_updateDataSet_inDB() {        
        try
        {
            ...
            Benutzer = System.getProperty("user.name"); 
            Statement myStatement = myConnection.createStatement();
            myStatement.executeUpdate("UPDATE DiafBDE.dbo.T_Unterbauleiste SET Höhe = '" + jFormattedTextField_Höhe.getText().trim() +
