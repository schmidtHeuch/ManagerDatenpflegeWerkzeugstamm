 ...
 * @author schmidtu
 */
public class Dialog_DataUse_Schnitt extends javax.swing.JDialog {

    /**
     * Creates new form Dialog_DataUse_Schnitt
     * @param parent
     * @param modal
     */
    public Dialog_DataUse_Schnitt(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable_dbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Schnitt-ID", "Bezeichnung", "Neu nach Produktion?"
            }
        ) {
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        ChoosenSchnitt_ID = myTableModel.getValueAt(myRow, 0).toString();
        this.dispose();
    ...
    public String getChoosenSchnitt_ID() {
        return ChoosenSchnitt_ID;
    }
    ...
    private void get_DBTableData() {        
        ...
        { 
            ...
            String mySQL = "SELECT * FROM DiafBDE.dbo.V_Schnitt";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_DataUse_Schnitt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Dialog_DataUse_Schnitt dialog = new Dialog_DataUse_Schnitt(new javax.swing.JFrame(), true);
